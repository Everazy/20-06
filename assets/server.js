...
const { default: firstLoginBonus }   = await import('./api/first-login-bonus.js');
const { default: claimReferral }     = await import('./api/claim-referral.js');
const { default: redeemPoints }      = await import('./api/redeem-points.js');
...
app.all('/api/first-login-bonus',   firstLoginBonus);
app.all('/api/claim-referral',      claimReferral);
app.all('/api/redeem-points',       redeemPoints);
